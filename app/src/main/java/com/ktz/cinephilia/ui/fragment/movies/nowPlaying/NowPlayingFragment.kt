package com.ktz.cinephilia.ui.fragment.movies.nowPlaying
...
import com.ktz.cinephilia.viewmodels.NowPlayingViewModel
...
import com.ktz.cinephilia.utils.snackAction
...
class NowPlayingFragment : Fragment(R.layout.fragment_movies_list) {
    ...
    private fun setUpWithLoadStateAdapter() {
